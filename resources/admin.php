		...
		<section id="cart_items">
			<div class="container">
				...
				<div class="row">
					...
					<!--<button type="submit" data-ng-click="logout()" class="btn btn-default pull-right">Logout</button>-->
					<ul class="nav navbar-nav pull-right">
						...
						<li><a href="register-admin.php" style="background-color: inherit!important;"><i class="fa fa-plus"></i> Register new admin</a></li>
						...
						<tbody>
                            <tr>
								<td class="cart_description">
									<a href="javascript:void(0)" data-ng-click="getAllEmails()">
										<h4>ALL SYSTEMS MAILS</h4>
										<p><span data-ng-bind="mailCount.systemMails"></span> total</p>
									</a>
								</td>
							</tr>
							<tr>
					...
					<div class="row">
						<div class="col-sm-8">
							<div class="contact-form">
								...
								<button type="submit" data-ng-click="flagAsHam(email.id)" class="btn btn-success pull-left" data-ng-show = "email.spam == 1">Flag As Ham</button>
								<button type="submit" data-ng-click="flagAsSpam(email.id)" class="btn btn-danger pull-left" data-ng-show = "email.spam == 0">Flag As Spam</button>
